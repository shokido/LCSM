module lom_array
  ...
  real(idx),allocatable :: cn(:),bn_1d(:)
  real(idx),allocatable :: hn_1d(:)
  ...
  real(idx),allocatable :: sdens_G(:,:,:)
  real(idx),allocatable :: time_sdens(:)
  real(idx),allocatable :: rhos_bvf(:,:)
end module lom_array
